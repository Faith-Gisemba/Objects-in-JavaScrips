...
const groupProductsByCategory = (productsArray) => {
    return productsArray.reduce((groupedProducts, product) => {
      (groupedProducts[product.category] = groupedProducts[product.category] || []).push(product);
...
console.log(filteredStudents); // Output: ["John", "Jane", "Jill"]




// Given an object representing a car, with properties for the make, model, year, and 
// a method to display the car's information, write a function that takes the car 
